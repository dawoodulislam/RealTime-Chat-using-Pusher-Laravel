        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="login-form">
                    ...
                    <p class="text-center">You are logging in as Customer</p>
                    ...
                    @endif
                    <!-- Form -->
                    <form class="form" method="post" action="{{ route('check-customer') }}">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group login-btn">
                                    ...
                                    <a href="{{ route('new-customer') }}" class="btn">Register</a>
                                </div>
                            </div>
                        </div>
                    </form>
